...
package com.gy.commonviewdemo.cusview.text.ticker;
...
class TickerColumnManager {
     ...
     * characterLists 每一个元素就是我们设置的text
     */
    void setCharacterLists(String... characterLists) {
        // characterLists 跟我们设置的字符串数组的长度相等 类型是 TickerCharacterList
        // 每一个 TickerCharacterList 持有一个字符串信息
    ...
    void setText(char[] text) {
        ...
        // 会给 tickerColumns 中填充 赋值 actions 决定每一个字母的动画
