...
class PageLinearAdapter : RecyclerView.Adapter<PageLinearAdapter.ViewHolder>(){


    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        // 知识点 recyclerView item 不充满全屏的问题    LayoutInflater.from(parent.context).inflate(R.layout.item_common_linear,null)
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.item_rv_cant_scroll,parent,false)
